...
const Services = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full h-auto gap-y-20 ">
      ...
      <div className="flex flex-col xl:flex-row gap-x-14 w-[100%] flex-wrap gap-y-4 justify-center items-center">
        <div className="flex flex-col items-center justify-center p-9 bg-light-black shadow-greens shadow-lg rounded-2xl gap-y-3 w-[80%] xl:w-[25%] hover:scale-110 group hover:shadow-lg hover:shadow-greens transition-all duration-500 ease-in-out cursor-pointer ">
          ...
          <FaReact
            className="z-10 text-greens group-hover:text-fade-black"
            size={60}
          />
          <h3 className="z-10 text-2xl text-greens font-radios group-hover:text-fade-black">
