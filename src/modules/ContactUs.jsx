  ...
  return (
    ...
    >
      ...
      <section className="py-24">
        <div className="px-4 mx-auto max-w-7xl sm:px- lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="w-full h-full group">
                <div className="relative h-full">
                  <img
                    ...
                    className="w-full h-full bg-indigo-700 lg:rounded-l-2xl rounded-2xl bg-blend-multiply"
                  />
            ...
            <div className="p-5 ml-5 bg-fade-black lg:p-11 lg:rounded-r-2xl rounded-2xl">
